...
import BookingDetailsModal from "../model-mansion/[id]/BookingDetailsModal";
      ...
      <div className="rounded-xl border border-[#2b2b2b] overflow-hidden bg-transparent">
        {bookings.map((booking, index) => (
          ...
          >
            ...
            {/* Middle */}
            <div className="w-full flex-1 rounded-md bg-white/10 p-4 cursor-pointer" onClick={()=>router.push(`/admin/model-market/${booking.id}`)}>
