...
export default function MessagesPage() {
  ...
  // Tracks whether the chat detail screen should be shown on mobile.
  // On mobile we start on the list; opening a chat flips this true,
  // and the back button flips it false again. On md+ screens this
  // flag is irrelevant since both panes show side by side.
  ...
  return (
    <main className="mx-auto flex h-[calc(100vh-150px)] min-h-[620px] w-full overflow-hidden rounded-lg border border-stone-800 bg-[#211c1e] shadow-2xl shadow-black/30">
      <aside
        className={`w-full min-w-0 flex-col border-r border-[#404040] bg-[#2d2729] md:flex md:max-w-[360px] lg:max-w-[430px] ${
